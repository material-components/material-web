 ...
 * @param saveAutoMode {=boolean} (Optional) Whether or not to save last auto
 *     mode to localstorage. Set to false if you simply want to query whether
 *     auto mode is dark or not. Defaults to true.
