...
- **BREAKING** Removed `mwc-icon-font.js` import. Most users should load the
  ...
  See the [Fonts](https://github.com/material-components/material-web#fonts)
...
- `<mwc-radio>` groups are now correctly synchronized when stamped using a
  ...
  connected at the same time ([#282](https://github.com/material-components/material-web/issues/282)).
...
- Published JavaScript files no longer include inlined TypeScript helpers such
  ...
  ([#439](https://github.com/material-components/material-web/pull/439))

- **BREAKING** Renamed component *`base`* modules:
  ([#440](https://github.com/material-components/material-web/pull/440)):
...
- Added "module" field in all packages' `package.json` manifests
  ([#434](https://github.com/material-components/material-web/pull/434))

## [0.7.0] - 2019-08-27

### Added
- New components:
  - [`<mwc-textfield>`](https://github.com/material-components/material-web/tree/master/packages/textfield) ([#297](https://github.com/material-components/material-web/pull/297))
  - [`<mwc-textarea>`](https://github.com/material-components/material-web/tree/master/packages/textarea) ([#297](https://github.com/material-components/material-web/pull/297))
  - [`<mwc-icon-button-toggle>`](https://github.com/material-components/material-web/tree/master/packages/icon-button-toggle) ([#370](https://github.com/material-components/material-web/pull/370))
  - [`<mwc-top-app-bar-fixed>`](https://github.com/material-components/material-web/tree/master/packages/top-app-bar-fixed) ([#379](https://github.com/material-components/material-web/pull/379))

- Added support for `<svg>` and `<img>` icons to `<mwc-icon-button>` and
  `<mwc-icon-button-toggle>`.
  ([#358](https://github.com/material-components/material-web/pull/358))

- Added `--mdc-snackbar-action-color` CSS custom property to `<mwc-snackbar>` to
  override the default action button color
  ([#354](https://github.com/material-components/material-web/pull/354)).
...
- Added a default slot to `<mwc-top-app-bar>` and `<mwc-top-app-bar-fixed>`
  ...
  ([#370](https://github.com/material-components/material-web/pull/370)).

- Added documentation for:
  - [`<mwc-button>`](https://github.com/material-components/material-web/tree/master/packages/button)
    ([#366](https://github.com/material-components/material-web/pull/366))
  - [`<mwc-fab>`](https://github.com/material-components/material-web/tree/master/packages/fab)
    ([#361](https://github.com/material-components/material-web/pull/361))
  - [`<mwc-icon-button>`](https://github.com/material-components/material-web/tree/master/packages/icon-button)
    ([#370](https://github.com/material-components/material-web/pull/370))
  - [`<mwc-radio>`](https://github.com/material-components/material-web/tree/master/packages/radio)
    ([#377](https://github.com/material-components/material-web/pull/377))
  - [`<mwc-snackbar>`](https://github.com/material-components/material-web/tree/master/packages/snackbar)
    ([#355](https://github.com/material-components/material-web/pull/355))
  - [`<mwc-top-app-bar>`](https://github.com/material-components/material-web/tree/master/packages/top-app-bar)
    ([#379](https://github.com/material-components/material-web/pull/379))

### Changed
- **BREAKING** The Material Icons font is no longer loaded automatically
  ([#314](https://github.com/material-components/material-web/pull/314)).
...
- **BREAKING** The *toggling* behavior of `<mwc-icon-button>` has been removed
  ...
  [`<mwc-icon-button-toggle>`](https://github.com/material-components/material-web/tree/master/packages/icon-button-toggle)
  component
  ([#370](https://github.com/material-components/material-web/pull/370)).
...
- **BREAKING** The *short* layout for `<mwc-top-app-bar>` has been removed, and
  ...
  specification
  ([#422](https://github.com/material-components/material-web/pull/422)).
...
- Fixed bug where `<mwc-snackbar>` `open` method threw if called immediately
  ...
  ([#356](https://github.com/material-components/material-web/pull/356)).
- Fixed bug where setting the `<mwc-snackbar>` `labelText` property could throw
  an exception and fail to render
  ([#412](https://github.com/material-components/material-web/pull/412)).
...
- Fixed layout issue affecting scrolling `<mwc-tab-bar>` in Firefox
  ([#349](https://github.com/material-components/material-web/pull/349)).
- Fixed bug where `<mwc-icon>` icons did not render in IE11
  ([#353](https://github.com/material-components/material-web/pull/353)).
- Fixed bug where setting the `checked` property on an `<mwc-radio>` did not
  ...
  ([#373](https://github.com/material-components/material-web/pull/373)).
