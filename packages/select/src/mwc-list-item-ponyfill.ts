...
export const controlTabIndex =
    (listItem: Element, tabIndex: string) => {
...
const getCheckbox =
    (listItem: Element) => {
      return listItem.querySelector(
                 'input[type="checkbox"]:not(:disabled),.checkbox:not([disabled])') as
          Element |
          HasChecked | null;
    }
...
const getRadio =
    (listItem: Element) => {
      return listItem.querySelector(
                 'input[type="radio"]:not(:disabled),.radio:not([disabled])') as
          Element |
          HasChecked | null;
    }

export const hasCheckbox =
    (listItem: Element) => {
      return !!getCheckbox(listItem);
    }

export const hasRadio =
    (listItem: Element) => {
...
export const setChecked =
    (listItem: Element, isChecked: boolean) => {
      const checkbox = getCheckbox(listItem);
